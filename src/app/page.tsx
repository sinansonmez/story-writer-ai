...
export default function Home() {
  ...
  const renderImage = () => {
    return image_url ? (
      <div className="flex flex-col items-center justify-center">
          <img className='rounded-md mt-8' src={image_url} />
      </div>
    ) : null;
  }
  ...
  const renderSpinner = () => {
    return loading ? (
      <div role="status">
        <svg aria-hidden="true" class="w-20 h-20 mt-20 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-red-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
